...
class Asset extends Component {
  ...
  componentDidMount () {
    const asset = this.props.assets.find(
      a => a.asset === this.props.match.params.username
    )
    this.setState({ asset })
    this.renderChart()
  ...
  renderStakingChart (data) {
    ...
    const { g, chartHeight, chartWidth } = initResponsive(
      '#asset-minting-chart',
      margins
    )
  ...
  renderChart () {
    ...
    g.append('path')
      .datum([
        { block: currentBlock, value: decayCurve(currentBlock) },
        { block: currentBlock, value: 0 }
      ])
          ...
          <div className='col-sm-4'>
            ...
            <div className='minting-stats'>
              ...
              <div className='total-minting'>
                ...
                <div id='asset-minting-chart' />
              </div>
            </div>
          </div>
          <div className='col-sm-6'>
            <div className='emissions'>
              <div className='chart' id='emissions-chart' />
            </div>
          </div>
